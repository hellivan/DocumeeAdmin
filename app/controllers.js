var appControllers = angular.module('controllers', ['services', 'ui.bootstrap']);

appControllers.controller("LoginController",
    function ($log, $scope, $rootScope, $location, $authentication) {
        // reset login status
...
appControllers.controller("ConsumersController",
    function ($log, $scope, $consumers){
        function update(){
